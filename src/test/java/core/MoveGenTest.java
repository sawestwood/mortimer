...
public class MoveGenTest {
    ...
    @Test
    public void examinePerftForInitialPositionAtDepth1() {
        // See https://www.chessprogramming.org/Perft_Results#Initial_Position
        long perft = perft(board, 1);
        assertEquals(20, perft);
    }

    @Test
    public void examinePerftForInitialPositionAtDepth2() {
        // See https://www.chessprogramming.org/Perft_Results#Initial_Position
        long perft = perft(board, 2);
        assertEquals(400, perft);
    }

    @Test
    public void examinePerftForInitialPositionAtDepth3() {
        // See https://www.chessprogramming.org/Perft_Results#Initial_Position
        long perft = perft(board, 3);
        assertEquals(8902, perft);
    }

    @Test
    public void examinePerftForInitialPositionAtDepth4() {
        // See https://www.chessprogramming.org/Perft_Results#Initial_Position
        long perft = perft(board, 4);
        assertEquals(197281, perft);
    }


    @Test
    public void examinePerftForInitialPositionAtDepth5() {
        // See https://www.chessprogramming.org/Perft_Results#Initial_Position
        long perft = perft(board, 5);
        assertEquals(4865609, perft);
    }
